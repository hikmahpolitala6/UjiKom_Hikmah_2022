...
$result = getData($filename, "segitiga") ?? [];
$segitiga_total = calculateTotalOfEachshape($result, "segitiga");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container py-4">
        ...
        <div class="p-5 mb-3 bg-light rounded">
            <div class="container text-warning">
                <h1 class="display-6 fw-bolder text-uppercase">Data Segitiga</h1>
                <p>Daftar Data Segitiga Yang Diinputkan</p>
            </div>

            <div class="container">
                <a href="./forms/form_add_segitiga.php" class="btn btn-primary float-end" role="button">+ Hitung</a>
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        if (is_array($result) && $segitiga_total != 0) {

                            foreach ($result as $key => $values) {
                                if (!empty($values["id_segitiga"])) {
